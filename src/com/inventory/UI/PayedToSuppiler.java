...
public class PayedToSuppiler extends javax.swing.JPanel {
    ...
    public PayedToSuppiler(Dashboard dashboard) {
        initComponents();
        ...
        event = new TableActionEvent() {
            ...
            public void onDelete(int row) {
                if (payedTable.isEditing()) {
                    payedTable.getCellEditor().stopCellEditing();
                }
                DefaultTableModel model = (DefaultTableModel) payedTable.getModel();
                //model.removeRow(row);
                String PurchaseIDS = String.valueOf(model.getValueAt(row, 2));
                loadPayedPurchaseDataSet(PurchaseIDS);
       ...
       SELECTED_SUPPLIER_ID = suppCombo.getSelectedItem()==null?0:((SupplierDTO) suppCombo.getSelectedItem()).getSuppID();
        ...
        payedTable.getSelectionModel().addListSelectionListener((e) -> {
...
//              PDImageXObject image = PDImageXObject.createFromFileByContent(file, document);
    ...
    {
        String path = PayedToSuppiler.class.getResource("/com/inventory/UI/Icons/bank_logo.png").getPath();
    ...
    private void initComponents() {
        ...
        payedTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        payedTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                payedTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(payedTable);

        payedPurchaseTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        payedPurchaseTable.setRowHeight(30);
        payedPurchaseTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                payedPurchaseTableMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(payedPurchaseTable);

        jLabel2.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel2.setText(" Purchase Detials, You Payed");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(suppCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 515, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void payedTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_payedTableMouseClicked
        int row = payedTable.getSelectedRow();
        int col = payedTable.getColumnCount();
...
//        }
    ...
    }//GEN-LAST:event_payedTableMouseClicked

    private void payedPurchaseTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_payedPurchaseTableMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_payedPurchaseTableMouseClicked
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        // TODO add your handling code here:
            ...
            int opt = JOptionPane.showConfirmDialog(
                null,
                "Are you sure you want to make a bank reciept for this payed invoice?",
                "Confirmation",
                JOptionPane.YES_NO_OPTION);
            if(opt==JOptionPane.YES_OPTION) {
                //int selectedRows[] = purchaseTable.getSelectedRows();
                DefaultTableModel model = (DefaultTableModel) payedPurchaseTable.getModel();
                ...
                {
                    total += Double.parseDouble(String.valueOf(model.getValueAt(i, 7)));
                    String resValue = String.valueOf(model.getValueAt(i, 8));
                    if(!commoditties.contains(resValue))
                    {
                        commoditties += " "+resValue;
                    }
                    String invoiceNO = String.valueOf(model.getValueAt(i, 4));
    ...
    private void loadPayedPurchaseDataSet(String PurchaseIDS) {
        try {
            PaymentsDAO paymentsDAO = new PaymentsDAO();
            payedPurchaseTable.setModel(paymentsDAO.buildTableModelPayment(paymentsDAO.getPurchaseInfoFor(PurchaseIDS)));
            for(int i=0;i<payedPurchaseTable.getColumnCount();i++)
            {
                if(i==0)
                {
                     ...
                     payedPurchaseTable.getColumnModel().getColumn(i).setMinWidth(0);
                     payedPurchaseTable.getColumnModel().getColumn(i).setMaxWidth(0);
                     payedPurchaseTable.getColumnModel().getColumn(i).setResizable(false);
                }
                else if(i==7)
                {
                    payedPurchaseTable.getColumnModel().getColumn(i).setCellRenderer(Supporter.renderer_right_bold);
                }
                else if(i==5 || i==6)
                {
                    payedPurchaseTable.getColumnModel().getColumn(i).setCellRenderer(Supporter.renderer_right);
                }
...
//                }
                ...
                {
                    payedPurchaseTable.getColumnModel().getColumn(i).setCellRenderer(Supporter.renderer_center);
                }
            }
    ...
    private void loadDataSet() {
        try {
            PaymentsDAO paymentsDAO = new PaymentsDAO();
            payedTable.setModel(paymentsDAO.buildPayedTableModel(paymentsDAO.getPayedInfoFor(SELECTED_SUPPLIER_ID)));
            for(int i=0;i<payedTable.getColumnCount();i++)
            {
                if(i==0)
                {
                     //purchaseTable.getColumnModel().getColumn(i).setPreferredWidth(-10);
                     ...
                     payedTable.getColumnModel().getColumn(i).setMinWidth(0);
                     payedTable.getColumnModel().getColumn(i).setMaxWidth(0);
                     payedTable.getColumnModel().getColumn(i).setResizable(false);
                }
                else if(i==3)
                {
                    payedTable.getColumnModel().getColumn(i).setCellRenderer(Supporter.renderer_right_bold);
                }
                else if(i==payedTable.getColumnCount()-1)
                {
                    payedTable.getColumnModel().getColumn(i).setCellRenderer(new TableActionCellViewRender());
                    payedTable.getColumnModel().getColumn(i).setCellEditor(new TableActionCellViewEditor(event));    
                }
                else
                {
                    payedTable.getColumnModel().getColumn(i).setCellRenderer(Supporter.renderer_center);
                }
            }
        } catch (SQLException throwables) {
            throwables.printStackTrace();
    ...
    public void loadSearchData(String text) {
        try {
            ...
            payedTable.setModel(productDAO.buildTableModelPayment(productDAO.getPurchaseSearch2(text)));
             for(int i=0;i<payedTable.getColumnCount();i++)
            {
                if(i==2)
                {
                    payedTable.getColumnModel().getColumn(i).setCellRenderer(Supporter.renderer_left);
                }
                else if(i==payedTable.getColumnCount()-1)
                {
                    payedTable.getColumnModel().getColumn(i).setCellRenderer(new TableActionCellRender());
                    payedTable.getColumnModel().getColumn(i).setCellEditor(new TableActionCellEditor(event));    
                }
                else
                {
                    payedTable.getColumnModel().getColumn(i).setCellRenderer(Supporter.renderer_center);
    ...
    private javax.swing.JTable payedPurchaseTable;
    private javax.swing.JTable payedTable;
