...
//            statement = conn.createStatement();
    ...
    public void editSupplierDAO(SupplierDTO supplierDTO) {
        try {
            ...
            prepStatement.setString(10, supplierDTO.getSuppCode());
            prepStatement.setString(11, supplierDTO.getSuppCode());
            prepStatement.setString(12, supplierDTO.getSuppCode());
            prepStatement.setString(13, supplierDTO.getSuppCode());
            prepStatement.setString(14, supplierDTO.getSuppCode());
            prepStatement.setString(15, supplierDTO.getSuppCode());
