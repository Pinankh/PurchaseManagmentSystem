...
//            conn = DriverManager.getConnection("jdbc:sqlite:sample.db");
    ...
    public void deletePurchaseDAO_new(int ID){
        try {
            String query = "DELETE FROM purchaseinfo WHERE purchaseID=?";
            prepStatement = conn.prepareStatement(query);
            prepStatement.setInt(1, ID);
    ...
    public ResultSet getPurchaseInfo2() {
        try {
            String query = "SELECT purchaseinfo.purchaseid,purchaseinfo.supplierID,STRFTIME('%d-%m-%Y', purchaseinfo.date) as date,suppliers.tpin_no,suppliers.fullname, purchaseinfo.invoiceNO,purchaseinfo.vatExclusiveValue,purchaseinfo.vatValue,purchaseinfo.totalcost,purchaseinfo.commodities FROM purchaseinfo INNER JOIN suppliers ON suppliers.sid = purchaseinfo.supplierID ORDER BY purchaseID DESC;";
            resultSet = statement.executeQuery(query);
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    ...
    // Purchase table data set retrieval
    public ResultSet getPurchaseInfoForVAT() {
        try {
            String query = "SELECT purchaseinfo.purchaseid,purchaseinfo.supplierID,STRFTIME('%d-%m-%Y', purchaseinfo.date) as date,suppliers.tpin_no,suppliers.fullname, purchaseinfo.invoiceNO,purchaseinfo.vatExclusiveValue,purchaseinfo.vatValue,purchaseinfo.totalcost,purchaseinfo.commodities FROM purchaseinfo INNER JOIN suppliers ON suppliers.sid = purchaseinfo.supplierID WHERE purchaseinfo.isTaxDone = 0 ORDER BY date DESC;";
            resultSet = statement.executeQuery(query);
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    ...
    // Purchase table data set retrieval
    public ResultSet getPurchaseInfoForGenratedVAT(String purchaseIDS) {
        try {
            String query = "SELECT purchaseinfo.purchaseid,purchaseinfo.supplierID,STRFTIME('%d-%m-%Y', purchaseinfo.date) as date,suppliers.tpin_no,suppliers.fullname, purchaseinfo.invoiceNO,purchaseinfo.vatExclusiveValue,purchaseinfo.vatValue,purchaseinfo.totalcost,purchaseinfo.commodities FROM purchaseinfo INNER JOIN suppliers ON suppliers.sid = purchaseinfo.supplierID WHERE purchaseinfo.purchaseID IN("+purchaseIDS+") ORDER BY date DESC;";
            resultSet = statement.executeQuery(query);
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    ...
    // Purchase table data set retrieval
    public ResultSet getPurchaseInfoFor(int id) {
        try {
            String query = "SELECT purchaseinfo.purchaseid,STRFTIME('%d-%m-%Y', purchaseinfo.date) as date,suppliers.tpin_no,suppliers.fullname, purchaseinfo.invoiceNO,purchaseinfo.vatExclusiveValue,purchaseinfo.vatValue,purchaseinfo.totalcost,purchaseinfo.isPayed,purchaseinfo.commodities FROM purchaseinfo INNER JOIN suppliers ON suppliers.sid = purchaseinfo.supplierID WHERE purchaseinfo.supplierID = "+id+" AND isPayed = 0 ORDER BY purchaseinfo.date;";
            resultSet = statement.executeQuery(query);
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    ...
    public ResultSet getPurchaseSearch2(String text) {
        try {
            String query = "SELECT purchaseinfo.purchaseid,purchaseinfo.supplierID,STRFTIME('%d-%m-%Y', purchaseinfo.date) as date,suppliers.tpin_no,suppliers.fullname, purchaseinfo.invoiceNO,purchaseinfo.vatExclusiveValue,purchaseinfo.vatValue,purchaseinfo.commodities,purchaseinfo.isPayed " +
                    ...
                    "OR date LIKE '%"+text+"%' OR purchaseinfo.commodities LIKE '%"+text+"%' ORDER BY date DESC";
            resultSet = statement.executeQuery(query);
        } catch (SQLException e) {
            e.printStackTrace();
        }
